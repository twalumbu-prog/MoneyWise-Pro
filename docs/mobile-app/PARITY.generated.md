...
Generated **2026-09-02** from `apps/web` + `apps/api`.
...
| shared | 96 | 26260 | AnimatedTabs, AuditScoreBreakdown, BankSelect, BookingCalendar, BucketLegend, BucketProgressBar, … |
...
| POST | `/cashbook/external-wallets` | CASHIER / ACCOUNTANT / ADMIN | DONE |
| DELETE | `/cashbook/external-wallets/:id` | ADMIN | PLANNED |
| POST | `/cashbook/external-wallets/:id/import-preview` | CASHIER / ACCOUNTANT / ADMIN | DONE |
| POST | `/cashbook/external-wallets/:id/import-statement` | CASHIER / ACCOUNTANT / ADMIN | DONE |
...
| POST | `/cashbook/transfer-to-wallet` | CASHIER / ACCOUNTANT / ADMIN | DONE |
...
| GET | `/payroll/config` | — | DONE |
| PUT | `/payroll/config` | — | DONE |
| GET | `/payroll/runs` | — | DONE |
| POST | `/payroll/runs` | — | DONE |
| GET | `/payroll/runs/:id` | — | DONE |
| POST | `/payroll/runs/:id/approve` | — | DONE |
| GET | `/payroll/runs/suggested-deductions` | — | DONE |
| GET | `/payroll/staff` | — | DONE |
| POST | `/payroll/staff` | — | DONE |
| GET | `/payroll/staff/:id` | — | DONE |
| PATCH | `/payroll/staff/:id` | — | DONE |
| DELETE | `/payroll/staff/:id` | — | DONE |
| GET | `/payroll/staff/:id/history` | — | DONE |
| GET | `/payroll/staff/departments` | — | DONE |
...
| POST | `/requisitions/:id/disburse-payroll` | — | DONE |
