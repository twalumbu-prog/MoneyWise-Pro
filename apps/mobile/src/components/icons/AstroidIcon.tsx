...
/** lucide's "astroid" icon — used for BI, matching web's AstroidIcon exactly. */
export const AstroidIcon: React.FC<{ color?: string; size?: number }> = ({ color = 'currentColor', size = 24 }) => (
