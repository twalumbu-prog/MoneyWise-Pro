...
async function main() {
  ...
  for await (const line of rl) {
    try {
      ...
      // Look for SYSTEM messages containing output of commands, or model steps calling command
      if (obj.source === 'SYSTEM' && obj.content && obj.content.includes('Task id') && obj.content.includes('finished with result')) {
